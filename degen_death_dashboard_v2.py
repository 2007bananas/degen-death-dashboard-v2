...
st.caption("Institutional Terminal • Prediction Markets + Spot Crypto")
...
with tab3:  # Crypto Spot Trading
    st.subheader("💱 Spot Crypto Trading")
    symbol = st.selectbox("Select Asset", ["BTC", "ETH"])
    amount = st.number_input("Amount ($)", min_value=10, max_value=500, value=100)
...
st.sidebar.caption("Burner wallet only • Start with $100–$500")
