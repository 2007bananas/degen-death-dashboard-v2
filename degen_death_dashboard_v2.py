...
<style>
    ...
    .header { font-size: 2.9rem; font-weight: 700; color: #ffffff; letter-spacing: -1px; }
    .card { background: #0f172a; padding: 22px; border-radius: 10px; border: 1px solid #1e2937; }
    .edge { border-left: 5px solid #22d3ee; }
    .timer { color: #f472b6; font-weight: 600; font-size: 1.4rem; }
    .metric-value { font-size: 2rem; font-weight: 600; color: #67e8f9; }
</style>
""", unsafe_allow_html=True)

st.markdown('<h1 class="header">NEXUS CAPITAL</h1>', unsafe_allow_html=True)
st.caption("Institutional Prediction Market Terminal • Live AI Execution")
...
with col3:
    st.metric("Active Edges", "11", "↑3")
with col4:
    st.metric("Win Rate", "87.2%", "↑4.1%")

st.success("🟢 LIVE • Connected to Polymarket Gamma API • AI Engine Online")
...
with tab1:
    ...
    st.info("All sub-agents running • Ready for execution")
...
st.sidebar.slider("Max Trade Size ($)", 50, 800, 250)
st.sidebar.caption("Use only a burner wallet\nStart with $100–$500")
